$(function() {
    ...
    $(".col").on("sortreceive", function(event, ui) {
    ...
    $("form").submit(function (event) {
        ...
        if (form.attr("id") === "create_list") {
            ...
            if (title === "") {
                ...
                $("nav").after("<header><div class=\"alert alert-danger border text-center alert-dismissible fade show\" role=\"alert\">UwU<button type=\"button\" class=\"btn-close\" data-bs-dismiss=\"alert\" aria-label=\"Close\"></button></div></header>")
                return false;
            }
                ...
                .done(function (data) {
                    ...
                    <div class="modal fade" id="list${data.list_id}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="list${data.list_id}Title" aria-hidden="true">
                            <div class="modal-dialog">
                                <form action="${data.url_for_mod}" method="POST" class="modify_list">
